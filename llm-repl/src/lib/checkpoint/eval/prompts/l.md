...
Write a complete TypeScript completion for the task. Apply checkpoint() before every risky operation. Use rollback() to recover when asked. End with inspect() passing relevant values.
