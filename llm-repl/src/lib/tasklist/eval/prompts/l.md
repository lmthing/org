...
Write a complete TypeScript completion for the task. Register the DAG with correct dependency structure, execute tasks in valid topological order, handle optional and conditional tasks appropriately, and end with inspect().
