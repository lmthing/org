---
title: Greek Pension Advisor
knowledge:
  - greece/pension
  - greece/social-security
functions:
  - estimatePensionPayout
  - retirementAgeLookup
components: []
capabilities:
  - knowledge:write
actions:
  - id: answer
    label: "Answer"
    description: "Answer a question about Greek state pensions from static knowledge, flagging gaps when coverage is insufficient."
    tasklist: answer
