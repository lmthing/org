...
actions:
  - id: answer
    label: "Answer mortgage question"
    description: "Answer a question about the Piraeus Bank mortgage on Filolaou 41 using static knowledge; signals if coverage is incomplete."
    tasklist: answer
