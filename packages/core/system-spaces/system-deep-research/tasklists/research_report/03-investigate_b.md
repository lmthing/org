...
`plan.questions[1]`. Your parent sees only the object you resolve, so synthesize — do not dump.
...
const question = (Array.isArray(plan.questions) && plan.questions[1]) ? String(plan.questions[1]) : "";
