...
`plan.questions[0]`. Your parent sees only the object you resolve, so synthesize — do not dump.
...
const question = (Array.isArray(plan.questions) && plan.questions[0]) ? String(plan.questions[0]) : "";
