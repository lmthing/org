...
describe('system spaces', () => {
  ...
  it('defaultSystemSpaceDirs points under libs/core/system-spaces', () => {
    ...
    expect(dirs.some((d) => d.endsWith('system-spaces/integration-google'))).toBe(true);
    expect(dirs.some((d) => d.endsWith('system-spaces/integration-slack'))).toBe(true);
    expect(dirs.some((d) => d.endsWith('system-spaces/integration-github'))).toBe(true);
