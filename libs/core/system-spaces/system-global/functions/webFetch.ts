...
export async function webFetch(
  url: string,
  opts?: { maxChars?: number; format?: 'text' | 'html' | 'markdown' },
): Promise<{ ok: boolean; status: number; content: string; truncated: boolean; error?: string }> {
  ...
  // Extract readable text/markdown by default — raw HTML is unusable for reading/summarizing.
  // The cap then applies to useful content rather than to markup. format:'html' opts out.
