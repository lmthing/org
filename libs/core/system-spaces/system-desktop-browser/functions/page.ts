...
/**
 * What is on screen right now: the current URL, page title, document readyState, and how far down the page is scrolled. Cheap — call it whenever you are unsure what you are looking at.
 */
export async function page(): Promise<{ ok: boolean; text: string; isError: boolean; error?: string }> {
  ...
  const request = { jsonrpc: '2.0', id: 1, method: 'tools/call', params: { name: 'page', arguments: {} } };
