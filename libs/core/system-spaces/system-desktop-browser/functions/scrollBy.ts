...
/**
 * Scroll the page vertically by `dy` pixels (default 600; negative scrolls up). Returns the new scroll position, so you can tell whether you reached the bottom.
 */
export async function scrollBy(args?: { dy?: number }): Promise<{ ok: boolean; text: string; isError: boolean; error?: string }> {
  ...
  const request = { jsonrpc: '2.0', id: 1, method: 'tools/call', params: { name: 'scrollBy', arguments: args ?? {} } };
