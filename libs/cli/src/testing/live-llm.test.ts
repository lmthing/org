 ...
 *   pnpm build && LM_LIVE=1 pnpm vitest run libs/cli/src/testing/live-llm.test.ts
 *
 ...
 * scenario saves its trace under libs/cli/.live-traces/<scenario>.jsonl.
 */
...
const ENGINEER = 'libs/core/system-spaces/system-engineer';
const ARCHITECT_SRC = resolve(REPO_ROOT, 'libs/core/system-spaces/system-architect');
