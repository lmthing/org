...
export function LiveActivity(): React.ReactElement | null {
  ...
  return (
    ...
    >
      <Prim.Row gap="$1.5" borderBottomWidth={1} borderColor="$border" paddingHorizontal="$3" paddingVertical="$1.5" fontSize="$xs" color="$muted-foreground" alignItems="center" lineHeight="1rem">
