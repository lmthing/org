  ...
  return (
    ...
    >
      ...
      <Prim.Col marginBottom="$10" alignItems="center">
        ...
        >
          Built it. <Prim.Text as="em" fontStyle="normal" color={colors.brand}>Validated it.</Prim.Text>{' '}
          Shipped it.
        </Prim.Text>
      </Prim.Col>
        ...
        {cards.map((card) => (
          ...
          >
            ...
            <Prim.Box
              ...
              backgroundColor="card.highlight ? colors.brand : colors.cardBorder" borderRadius="16px 16px 0 0"
            />
            ...
            <Prim.Box
              ...
              color={card.highlight ? colors.brand : colors.text} letterSpacing="-0.03em"
            >
              {card.stat}
            </Prim.Box>

            <Prim.Box fontSize="$2xl" fontWeight="$bold" marginBottom="0.75rem" color={colors.text}>
              {card.title}
            </Prim.Box>
            ...
            <Prim.Box fontSize="$lg" lineHeight="1.65" color={colors.textSecondary}>
              {card.body}
            </Prim.Box>
          </Prim.Col>
        ))}
