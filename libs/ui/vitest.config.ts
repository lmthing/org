...
//
// Scope: the Phase-0 vocabulary primitives (elements/primitives/**). The rest of libs/ui's
// co-located *.test.tsx suites depend on Radix/lucide/etc. peers that are not installed here;
// widening this include is follow-up work once those peers are added.
...
export default defineConfig({
  ...
  test: {
    environment: 'jsdom',
    include: ['src/elements/primitives/**/*.test.tsx'],
