...
import { getCustomProvider, isCustomProvider, listCustomProviders } from './custom.js';
...
const builtInProviderLoaders: Record<BuiltInProviderName, () => Promise<ProviderFactory>> = {
  openai: async () => (await import('./openai.js')).openai,
  anthropic: async () => (await import('./anthropic.js')).anthropic,
  google: async () => (await import('./google.js')).google,
  mistral: async () => (await import('./mistral.js')).mistral,
  azure: async () => (await import('./azure.js')).azure,
  groq: async () => (await import('./groq.js')).groq,
  cohere: async () => (await import('./cohere.js')).cohere,
  bedrock: async () => (await import('./bedrock.js')).bedrock,
};
