...
1. Identify the task DAG structure and topological order
2. Plan the order of start()/finish() calls to respect all deps
3. Handle optional tasks and conditions appropriately
4. Complete all required tasks, then end with inspect()
